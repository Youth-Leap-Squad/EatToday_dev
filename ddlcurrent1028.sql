...
-- 41. 소고기무국과 소주
(2, 2, '소고기무국과 소주', '속이 따뜻해지는 국물 안주', '담백한 맛이 소주와 찰떡', '/images/food/BeefRadishSoup.jpg',
 '2025-10-22 18:40:00', 140, 'T', 7, 4, 1, 0),
-- 42. 닭볶음탕과 소주
(2, 1, '닭볶음탕과 소주', '매콤한 닭볶음탕에 소주 한잔', '얼큰한 국물이 포인트', '/images/food/SpicyBraisedChicken.jpg',
 '2025-10-23 19:10:00', 210, 'T', 10, 6, 2, 1),
-- 43. 소세지야채볶음과 소주
(2, 3, '소세지야채볶음과 소주', '짭짤한 안주에 소주가 술술', '가정식 안주 느낌', '/images/food/StirfriedSausageVegetableswithSoju.jpg',
 '2025-10-24 20:20:00', 160, 'T', 6, 3, 1, 0),
-- 44. 제육볶음과 소주
(2, 2, '제육볶음과 소주', '한국인의 소울푸드 제육볶음', '기름진 고기와 매콤한 양념이 소주에 딱', '/images/food/SpicyPorkStirfry.jpg',
 '2025-10-25 19:00:00', 220, 'T', 9, 5, 2, 1),
-- 45. 치즈플래터와 와인
(8, 1, '치즈플래터와 와인', '고다치즈, 브리치즈와 함께 즐기는 와인', '가볍게 즐기기 좋은 기본 안주', '/images/food/CheesePlatter.jpg',
 '2025-10-26 20:00:00', 310, 'T', 14, 11, 4, 2),
-- 46. 스테이크와 와인
(8, 2, '스테이크와 와인', '두툼한 스테이크에 레드와인 한잔', '고급진 조합의 정석', '/images/food/Steak.jpg',
 '2025-10-27 21:00:00', 420, 'T', 18, 13, 5, 3),
-- 47. 까망베르치즈구이
(8, 3, '까망베르치즈구이', '오븐에 구운 치즈 안주', '와인향을 돋워주는 고소한 맛', '/images/food/BakedCamembertCheese.jpg',
 '2025-10-28 19:20:00', 180, 'T', 10, 8, 3, 1),
-- 48. 토마토파스타와 와인
(8, 1, '토마토파스타와 와인', '산뜻한 토마토소스 파스타에 화이트와인', '가벼운 식사 안주로 좋음', '/images/food/TomatoPasta.jpg',
 '2025-10-29 18:30:00', 260, 'T', 13, 9, 3, 2),
-- 49. 브리오슈와 와인
(8, 2, '브리오슈와 와인', '달콤한 빵과 와인의 의외의 궁합', '디저트 와인용', '/images/food/Brioche.jpg',
 '2025-10-30 17:00:00', 150, 'T', 6, 5, 2, 1),
-- 50. 리조또와 와인
(8, 3, '리조또와 와인', '크리미한 리조또에 화이트와인', '부드러운 풍미', '/images/food/Risotto.jpg',
 '2025-10-31 19:10:00', 270, 'T', 11, 8, 3, 2),
-- 51. 프로슈토와 와인
(8, 1, '프로슈토와 와인', '짭짤한 햄이 와인과 찰떡', '이탈리아식 기본 안주', '/images/food/Prosciutto.jpg',
 '2025-11-01 20:00:00', 320, 'T', 15, 12, 4, 2),
-- 52. 과일치즈샐러드와 와인
(8, 2, '과일치즈샐러드와 와인', '상큼한 과일과 치즈의 조화', '가벼운 와인 안주', '/images/food/FruitCheeseSalad.jpg',
 '2025-11-02 18:40:00', 210, 'T', 8, 6, 2, 1),
-- 53. 연어카르파초와 와인
(8, 3, '연어카르파초와 와인', '신선한 연어에 레몬향 와인', '산뜻한 입맛 돋움', '/images/food/SalmonCarpaccio.jpg',
 '2025-11-03 19:30:00', 230, 'T', 12, 9, 3, 2),
-- 54. 버섯크림파스타와 와인
(8, 1, '버섯크림파스타와 와인', '부드러운 크림소스에 레드와인 한잔', '식사 겸 안주로 좋음', '/images/food/MushroomCreamPasta.jpg',
 '2025-11-04 20:30:00', 200, 'T', 9, 6, 3, 1),
-- 55. 스모크치킨과 와인
(8, 2, '스모크치킨과 와인', '훈제향이 은은하게 퍼지는 치킨 안주', '화이트와인과 찰떡', '/images/food/SmokedChicken.jpg',
 '2025-11-05 19:40:00', 195, 'T', 7, 5, 2, 1),
-- 56. 크로스티니와 와인
(8, 3, '크로스티니와 와인', '토마토, 올리브, 치즈 토핑의 바게트', '이탈리아식 가벼운 안주', '/images/food/Crostini.jpg',
 '2025-11-06 18:50:00', 250, 'T', 10, 8, 3, 1);
...
VALUES
-- 🥃 소주 (alcohol_no = 2)
(1, 1, '치즈닭발은 역시 소주죠!', '2025-10-21'),
(2, 1, '매운 거 싫어하는데 이건 맛있네요.', '2025-10-22'),
(3, 1, '치즈 덕분에 매운맛이 중화돼요.', '2025-10-23'),

(4, 3, '오돌뼈는 진짜 술을 부르는 맛!', '2025-10-22'),
(5, 3, '식감이 쫀득해서 좋아요.', '2025-10-23'),
(6, 3, '이건 친구들이랑 먹으면 최고!', '2025-10-24'),

(7, 6, '불족발엔 소주 필수!', '2025-10-20'),
(8, 6, '불향이 너무 좋아요.', '2025-10-21'),
(9, 6, '살짝 단맛도 있어서 맛있어요.', '2025-10-22'),

(10, 10, '삼겹살엔 소주죠!', '2025-10-13'),
(11, 10, '기본이지만 최고 조합.', '2025-10-14'),
(12, 10, '사진만 봐도 군침 도네요.', '2025-10-15'),

(13, 12, '문어숙회에 소주 한잔 완벽하죠.', '2025-10-11'),
(14, 12, '심플하지만 깊은 맛 인정.', '2025-10-12'),
(15, 12, '문어가 진짜 신선해보이네요.', '2025-10-13'),

(16, 16, '두부김치에 소주라니, 전통 조합!', '2025-10-12'),
(17, 16, '매콤한 김치가 완전 맛있어 보여요.', '2025-10-13'),
(18, 16, '따뜻한 두부에 김치 한입 최고.', '2025-10-14'),

(19, 20, '순대볶음엔 역시 소주!', '2025-10-05'),
(20, 20, '매콤달콤해서 술이 계속 들어가요.', '2025-10-06'),
(21, 20, '양념이 너무 맛있어요.', '2025-10-07'),

(22, 22, '낙지볶음 매콤해서 좋네요.', '2025-10-04'),
(23, 22, '낙지 식감이 살아있어요.', '2025-10-05'),
(24, 22, '소주 안주로 딱입니다.', '2025-10-06'),

(1, 24, '오징어볶음은 소주 안주 끝판왕!', '2025-10-02'),
(2, 24, '불맛이 정말 나네요.', '2025-10-03'),
(3, 24, '밥이랑 먹어도 꿀맛이에요.', '2025-10-04'),

(4, 33, '매운 닭꼬치엔 소주가 찰떡!', '2025-09-23'),
(5, 33, '불향이 제대로네요.', '2025-09-24'),
(6, 33, '길거리 감성 좋네요.', '2025-09-25'),

(7, 37, '어묵탕 국물이 진짜 시원해요.', '2025-09-19'),
(8, 37, '겨울에 생각나는 안주죠.', '2025-09-20'),
(9, 37, '이거 해장에도 좋겠네요.', '2025-09-21'),

(10, 40, '오돌뼈덮밥 이건 반칙이네요.', '2025-09-16'),
(11, 40, '밥까지 있어서 든든해요.', '2025-09-17'),
(12, 40, '매콤하니 술술 들어갑니다.', '2025-09-18'),

(13, 41, '국물 맛있어 보이네요!', '2025-10-22'),
(14, 41, '시원한 무국에 소주 한잔 최고.', '2025-10-23'),
(15, 41, '술안주보단 해장에도 좋을 듯.', '2025-10-24'),

(16, 42, '닭볶음탕엔 진짜 소주죠!', '2025-10-23'),
(17, 42, '얼큰해서 딱 좋아요.', '2025-10-24'),
(18, 42, '사진만 봐도 군침 돕니다.', '2025-10-25'),

(19, 44, '제육볶음은 언제나 옳죠.', '2025-10-25'),
(20, 44, '매콤하니 소주가 절로 들어가요.', '2025-10-26'),
(21, 44, '고기 양념이 맛있어 보이네요.', '2025-10-27'),

-- 🍷 와인 (alcohol_no = 8)
(22, 2, '감바스에 와인은 진리죠.', '2025-10-19'),
(23, 2, '올리브오일 향 너무 좋아요.', '2025-10-20'),
(24, 2, '빵이랑 같이 먹으면 최고!', '2025-10-21'),

(1, 18, '숙성회에 화이트와인 조합 미쳤다.', '2025-10-07'),
(2, 18, '일식집 느낌 나네요.', '2025-10-08'),
(3, 18, '깔끔한 맛이 좋아요.', '2025-10-09'),

(4, 34, '회무침에 와인이라니 신선한 조합!', '2025-09-22'),
(5, 34, '생각보다 잘 어울리네요.', '2025-09-23'),
(6, 34, '이건 꼭 따라 해볼래요.', '2025-09-24'),

(7, 36, '치즈감바스에 와인이라니 완벽!', '2025-09-20'),
(8, 36, '감바스에 치즈 추가는 신의 한 수.', '2025-09-21'),
(9, 36, '레드와인이랑도 잘 어울리죠.', '2025-09-22'),

(10, 38, '브루스케타엔 와인이 국룰.', '2025-09-18'),
(11, 38, '토마토랑 바질 향 너무 좋아요.', '2025-09-19'),
(12, 38, '이탈리아 감성 가득하네요.', '2025-09-20'),

(13, 45, '치즈플래터엔 와인 한잔이 딱이죠.', '2025-10-26'),
(14, 45, '고다치즈 최고!', '2025-10-27'),
(15, 45, '브리치즈 너무 좋아요.', '2025-10-28'),

(16, 46, '스테이크엔 와인, 말이 필요없죠.', '2025-10-27'),
(17, 46, '레드와인이랑 완벽한 밸런스!', '2025-10-28'),
(18, 46, '식욕이 확 도네요.', '2025-10-29'),

(19, 47, '까망베르치즈구이는 와인 안주 끝판왕.', '2025-10-29'),
(20, 47, '고소한 치즈 향이 좋아요.', '2025-10-30'),
(21, 47, '빵이랑 같이 먹으면 최고.', '2025-10-31'),

(22, 48, '토마토파스타에 화이트와인 찰떡!', '2025-10-30'),
(23, 48, '가볍고 상큼한 조합이에요.', '2025-10-31'),
(24, 48, '이 조합 진짜 자주 해먹어요.', '2025-11-01'),

(1, 50, '리조또에 와인 한잔 완벽하죠.', '2025-10-31'),
(2, 50, '크리미해서 너무 좋아요.', '2025-11-01'),
(3, 50, '화이트와인이 딱이네요.', '2025-11-02'),

(4, 52, '과일치즈샐러드 상큼하네요!', '2025-11-02'),
(5, 52, '가볍게 마시기 좋아요.', '2025-11-03'),
(6, 52, '와인 초보자에게 추천!', '2025-11-04'),

(7, 53, '연어카르파초에 와인 조합 완벽.', '2025-11-03'),
(8, 53, '산뜻한 맛이 와인이랑 잘 맞아요.', '2025-11-04'),
(9, 53, '깔끔한 안주네요.', '2025-11-05'),

(10, 55, '스모크치킨 향 너무 좋다.', '2025-11-05'),
(11, 55, '화이트와인하고 잘 어울려요.', '2025-11-06'),
(12, 55, '훈제향이 강하지 않아 좋네요.', '2025-11-07'),

(13, 56, '크로스티니랑 와인 조합 세련됐네요.', '2025-11-06'),
(14, 56, '토마토랑 치즈 조합 굿.', '2025-11-07'),
(15, 56, '간단하지만 분위기 좋아요.', '2025-11-08');
