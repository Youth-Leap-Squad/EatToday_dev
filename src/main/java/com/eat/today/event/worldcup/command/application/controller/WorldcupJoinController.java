...
//    @GetMapping("/check")
//    public void checkPlayed(@RequestParam int memberNo,
//                            @RequestParam int worldcupNo,
//                            @RequestParam int alcoholId) {
//
//        boolean exists = worldcupJoinMemberAlcoholRepository
//                .existsByMemberNoAndWorldcupNoAndAlcoholId(memberNo, worldcupNo, alcoholId);
//
